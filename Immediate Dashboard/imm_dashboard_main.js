...
$(document).ready(function() {
       ...
       /* getItems('IT Request (Hardware/Software/Issue Report)',"<View><Query><OrderBy><FieldRef Name='ID' Ascending='FALSE'/></OrderBy><Where><And><Eq><FieldRef Name='Status'/><Value Type='Text'>For Department Head Approval</Value></Eq><Eq><FieldRef Name='Department_x0020_Head'/><Value Type='Integer'><UserID Type='Integer'/></Value></Eq></And></Where></Query></View>");
*/
