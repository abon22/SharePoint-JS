...
var avg_div;
 ...
 $(document).ready(function(){
         ...
         var list = context.get_web().get_lists().getByTitle('Employee Meal Satisfaction Survey');  
...
var total_1 = 0, total_2 = 0, total_3 = 0, total_4 = 0, total_5 = 0, total_6 = 0, total_7 = 0, total_8 = 0, total_9 = 0, total_10 = 0, total_11 = 0, total_12 = 0;
...
// if(id==4){
//                     // jul_question_1 = jul_question_1+listItem.get_item('Type_x0020_your_x0020_question_x'); 
//                     jul_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x'); 
// //console.log(jul_question_1);
...
//alert(uniqueArr[i]+" : "+fmtcreatedyear);
                if( uniqueArr[i]==fmtcreatedyear){
                    ...
                    if(fmtcreatedmonth=="Jan"){
                        count_by_jan++;
                        jan_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        jan_question_1.forEach(function(obj){total_1 += obj.$1z_1; })
                    
                    }else if(fmtcreatedmonth=="Feb"){
                        count_by_feb++;
                        feb_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        feb_question_1.forEach(function(obj){total_2 += obj.$1z_1; })

                    }else if(fmtcreatedmonth=="Mar"){
                        count_by_mar++;
                        mar_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        mar_question_1.forEach(function(obj){total_3 += obj.$1z_1; })

                    }else if(fmtcreatedmonth=="Apr"){
                        count_by_apr++;
                        apr_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        apr_question_1.forEach(function(obj){total_4 += obj.$1z_1; })

                    }else if(fmtcreatedmonth=="May"){
                        count_by_may++;
                        may_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        may_question_1.forEach(function(obj){total_5 += obj.$1z_1; })

                    }else if(fmtcreatedmonth=="Jun"){
                        count_by_jun++;

                        jun_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        jun_question_1.forEach(function(obj){total_6 += obj.$1z_1; })
                        ...
                        jul_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        jul_question_1.forEach(function(obj){total_7 += obj.$1z_1; })
                       //console.log("output: " + total_7);
                        ...
                        count_by_aug++;
                        aug_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        aug_question_1.forEach(function(obj){total_8 += obj.$1z_1; })
                    }else if(fmtcreatedmonth=="Sept"){
                        count_by_sep++;

                         sep_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        sep_question_1.forEach(function(obj){total_9 += obj.$1z_1; })
                    }else if(fmtcreatedmonth=="Oct"){
                        count_by_oct++;
                        oct_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        oct_question_1.forEach(function(obj){total_10 += obj.$1z_1; })

                    }else if(fmtcreatedmonth=="Nov"){
                        count_by_nov++;
                        nov_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        nov_question_1.forEach(function(obj){total_11 += obj.$1z_1; })
                    }else if(fmtcreatedmonth=="Dec"){
                        count_by_dec++;
                        dec_question_1 = listItem.get_item('Type_x0020_your_x0020_question_x');
                        dec_question_1.forEach(function(obj){total_12 += obj.$1z_1; })
                    }
...
// $('#table_id').append("<tr class='ms-rteTableFooterRow-default'> <td class='ms-rteTableFooterEvenCol-default' rowspan='1' style='width: 5%; text-align: center;'> "+field+'</td></tr>');
           ...
           // //console.log("NAN: "+((jan_question_1+jan_question_2+jan_question_3)/3)/count_by_jan);
            totalperjan= (total_1/3)/count_by_jan;
           ...
           // //console.log("Avg Jan: "+parseFloat(totalperjan));
            ...
            totalperfeb= (total_2/3)/count_by_feb;
            ...
            totalpermar= (total_3/3)/count_by_mar;
            ...
            totalperapr= (total_4/3)/count_by_apr;
            ...
            totalpermay= (total_5/3)/count_by_may;
            ...
            totalperjul= (total_6/3)/count_by_jun;
           ...
           // //console.log("Jul Responses: "+count_by_jul);
            ...
            totalperjul= (total_7/3)/count_by_jul;
            totalperjul = totalperjul || 0;
            ////console.log("Avg Jul: "+parseFloat(totalperjul));
            var jul_append ="<td class='ms-rteTableFooterEvenCol-default' rowspan='1' style='widzth: 5%; text-align: center;'> "+parseFloat(totalperjul).toFixed(2)+"</td>";

            ////console.log("Aug Responses: "+count_by_aug);
            totalperaug= (total_8/3)/count_by_aug;
            ...
            totalpersep= (total_9/3)/count_by_sep;
            ...
            totalperoct= (total_10/3)/count_by_oct;
            ...
            totalpernov= (total_11/3)/count_by_nov;
            ...
            totalperdec= (total_12/3)/count_by_dec;
      ...
      function drawChart() {
        dataTable = google.visualization.arrayToDataTable([
         ['Year', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
           ...
           var options = {
          chart: {
            title: 'Employee Customer Satisfaction Survey Chart',
