...
$('#WebPartTitleWPQ5').append("<br>"+html_pca_immediate_approve_btn2_v3);//pca_immediate
$('#WebPartTitleWPQ6').append("<br>"+html_pca_approve_btn2_v3);//pca_ceo
//end------------------------------------------------------------------------------------------------------------------
...
$('#WebPartTitleWPQ9').append("<br>"+html_por_immediate_approve_btn2_v3);
$('#WebPartTitleWPQ10').append("<br>"+html_por_approve_btn2_v3);
//end------------------------------------------------------------------------------------------------------------------
...
//start------------------------------------------------------------------------------------------------------------------
$('#WebPartTitleWPQ15').append("<br>"+html_mrf_approve_btn2);//mrf_ceo
//end------------------------------------------------------------------------------------------------------------------

//$('#WebPartTitleWPQ15').append(html_lqf_immediate_approve_btn);//lqf_immediate --Done Test

//start------------------------------------------------------------------------------------------------------------------
$('#WebPartTitleWPQ16').append("<br>"+html_lqf_immediate_approve_btn2);//lqf_immediate
//end------------------------------------------------------------------------------------------------------------------

//$('#WebPartTitleWPQ16').append(html_fbp_approve_btn);//fbp_ceo --Done Test

//start------------------------------------------------------------------------------------------------------------------
$('#WebPartTitleWPQ17').append("<br>"+html_fbp_approve_btn2);//fbp_ceo 
//end------------------------------------------------------------------------------------------------------------------
...
$('#WebPartTitleWPQ20').append("<br>"+html_rbf_approve_btn2_v3);//sdl_ceo
$('#WebPartTitleWPQ21').append("<br>"+html_rbf_immediate_approve_btn2_v3);//rbf_immediate
...
//start------------------------------------------------------------------------------------------------------------------
$('#WebPartTitleWPQ24').append("<br>"+html_ebf_approve_btn2);//ebf_ceo
//$('#WebPartTitleWPQ17').append("<br>"+html_prp_approve_btn2);//ofe_ceo
//end------------------------------------------------------------------------------------------------------------------


//start------------------------------------------------------------------------------------------------------------------
$('#WebPartTitleWPQ25').append("<br>"+html_prp_approve_btn2);//prp_ceo
//end------------------------------------------------------------------------------------------------------------------
