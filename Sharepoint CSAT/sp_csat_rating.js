...
//alert(uniqueArr[i]+" : "+fmtcreatedyear);
                if( uniqueArr[i]==fmtcreatedyear){
                    ...
                    if(fmtcreatedmonth=="Jan"){
                        count_by_jan++;
                        jan_question_1 = jan_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        jan_question_2 = jan_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        jan_question_3 = jan_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');
                    
                    }else if(fmtcreatedmonth=="Feb"){
                        count_by_feb++;
                        feb_question_1 = feb_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        feb_question_2 = feb_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        feb_question_3 = feb_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Mar"){
                        count_by_mar++;
                        mar_question_1 = mar_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        mar_question_2 = mar_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        mar_question_3 = mar_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Apr"){
                        count_by_apr++;
                        apr_question_1 = apr_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        apr_question_2 = apr_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        apr_question_3 = apr_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="May"){
                        count_by_may++;
                        may_question_1 = may_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        may_question_2 = may_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        may_question_3 = may_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Jun"){
                        count_by_jun++;

                        jun_question_1 = jun_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        jun_question_2 = jun_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        jun_question_3 = jun_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Jul"){
                        count_by_jul++;

                         jul_question_1 = jul_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        jul_question_2 = jul_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        jul_question_3 = jul_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');
                    }else if(fmtcreatedmonth=="Aug"){
                        count_by_aug++;
                        aug_question_1 = aug_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        aug_question_2 = aug_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        aug_question_3 = aug_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');
                    }else if(fmtcreatedmonth=="Sep"){
                        count_by_sep++;

                         sep_question_1 = sep_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        sep_question_2 = sep_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        sep_question_3 = sep_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');
                    }else if(fmtcreatedmonth=="Oct"){
                        count_by_oct++;
                         oct_question_1 = oct_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        oct_question_2 = oct_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        oct_question_3 = oct_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Nov"){
                        count_by_nov++;
                        nov_question_1 = nov_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        nov_question_2 = nov_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        nov_question_3 = nov_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');

                    }else if(fmtcreatedmonth=="Dec"){
                        count_by_dec++;
                        dec_question_1 = dec_question_1+listItem.get_item('How_x0020_would_x0020_you_x0020_'); 
                        dec_question_2 = dec_question_2+listItem.get_item('How_x0020_would_x0020_you_x0020_0');
                        dec_question_3 = dec_question_3+listItem.get_item('How_x0020_likely_x0020_are_x0020');
                    }
...
//console.log(array_rows);
 ...
 var options = {
          chart: {
            title: 'SharePoint Satisfaction Survey Chart',
            subtitle: '',
          }
        };
