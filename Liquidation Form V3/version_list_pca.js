...
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/table.css" rel="stylesheet" type="text/css" />
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/menu.css" rel="stylesheet" type="text/css" />
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/dropdown.min.css" rel="stylesheet" type="text/css" />
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/progress.css" rel="stylesheet" type="text/css" />
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/icon.css" rel="stylesheet" type="text/css" />
<link href="/SiteAssets/Scripts/Payment or CA Request V3/css/transition.min.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/SiteAssets/Scripts/Payment or CA Request V3/js/progress.js"></script>
<script type="text/javascript" src="/SiteAssets/Scripts/Payment or CA Request V3/js/tablesort.js"></script>
<script type="text/javascript" src="/SiteAssets/Scripts/Payment or CA Request V3/js/dropdown.min.js"></script>
<script type="text/javascript" src="/SiteAssets/Scripts/Payment or CA Request V3/js/transition.min.js"></script>

<script src="/SiteAssets/Scripts/Payment or CA Request V3/js/pagination.js"></script>
...
function GetPORListItem(selected_year, selected_month)  
{
  ...
  z=1;
	...
	$.ajax({
		url:  _spPageContextInfo.webAbsoluteUrl  + "/_api/web/lists/getbytitle('Payments/CA Request')/items?$select=Title, Created, ID &$OrderBy=Title desc",
		method: "GET",
...
var arr_keyToFind = [];
var arr_findThis = ['Reference Number', 'Immediate Head Status', 'Finance Status', 'VP Approval', 'CEO Approval']
...
var total_immediate_head=0, total_finance=0, total_vp=0, total_ceo=0, total_cycle_time_temp=0 ;
   ...
   if(selected_year == year && selected_month == temp_month){
        ...
        if( typeof por_object[object_key_por[i]]['05_CEO_Approval'] === "undefined"){
          ...
          ceo_status = por_object[object_key_por[i]]['05_CEO_Approval']['CEO Approval'];
		  	...
		  	var total_cycle_time = Number(immediate_head)  + Number(finance) + Number(vp) + Number(ceo)  ;
            ...
            $('#tbody_id').append("<tr>"+
            "<td>"+date_temp +"</td>"+
            "<td><a href='https://intranet.houseofit.com.au/Lists/PaymentsCA%20Request/DispForm.aspx?ID="+substring_id+"' target='_blank'>"+ref_no+"</a></td>"+
            ...
            "<td "+((finance == '' ) ? '': '')+" >"+((finance == '' ) ? '' : Number(finance).toFixed(2) )+"</td>"+
            "<td "+((vp_status == 'Approved') ? "class='positive'" : ((vp_status == 'N/A') ? ((finance == '') ? '' : ((finance_status =="For CEO")? "class='disabled'" : '')) : "class='negative'" ) )+" >"+((vp_status == 'Approved') ? Number(vp).toFixed(2) : ((vp_status == 'N/A') ? ((finance == '') ? '' : ((finance_status =="For CEO")? '<i>N/A</i>' : '')) : Number(vp).toFixed(2) ) )+"</td>"+
            "<td "+((ceo_status == 'Approved') ? "class='positive'" : ((ceo_status == 'N/A') ? ((vp_status == '' || vp_status == 'N/A')? '':"class='disabled'" ) : "class='negative'")  )+" >"+
            ((ceo_status == 'Approved') ? Number(ceo).toFixed(2) : ((ceo_status == 'N/A') ? ((vp_status == '' || vp_status == 'N/A')? '' : '<i>N/A</i>' ) :  Number(ceo).toFixed(2))  )+"</td>"+
