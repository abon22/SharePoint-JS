...
function init(){
 ...
 itemId = GetUrlKeyValue("ID", false, location.href);
         ...
         var list = context.get_web().get_lists().getByTitle('Payment/CA Request');
 ...
 console.log("immediate_head: "+immediate_head);
  ...
  if(immediate_head_status==""){
    ...
    if(immediate_head==get_login_preferredname  || targetUser=="litoa" || targetUser=="aysoukhomlinov" || targetUser=="artems" || targetUser=="System Account"){
      ...
      SPUtility.ShowSPField('Immediate Head Status');
      $("input[id='ctl00_ctl43_g_2b4f409e_bc8e_4b6a_8987_bf8efb882d10_ctl00_toolBarTbl_RightRptControls_ctl00_ctl00_diidIOSaveItem']").attr('disabled', 'disabled');
      $("a[id='Ribbon.ListForm.Edit.Commit.Publish-Large']").css("visibility","hidden");
        ...
        SPUtility.ShowSPField('Immediate Head Status');
         ...
         $("input[id='ctl00_ctl43_g_2b4f409e_bc8e_4b6a_8987_bf8efb882d10_ctl00_toolBarTbl_RightRptControls_ctl00_ctl00_diidIOSaveItem']").attr('disabled', 'hidden');
      $("a[id='Ribbon.ListForm.Edit.Commit.Publish-Large']").css("visibility","hidden");
        }
...
//should be uncomment || "Lito Abon Jr." == get_login_preferredname
  ...
  if(created_by==get_login_preferredname ){
    console.log("in");
    $("input[id='ctl00_ctl43_g_2b4f409e_bc8e_4b6a_8987_bf8efb882d10_ctl00_toolBarTbl_RightRptControls_ctl00_ctl00_diidIOSaveItem']").removeAttr('disabled');
