...
$(document).ready(function() {
    ...
    getItems('Salary or Device Loan Benefits',"<View><Query><OrderBy><FieldRef Name='IssueID' Ascending='FALSE'/></OrderBy><Where><And><Eq><FieldRef Name='Immediate_x0020_Head_x0020_Statu'/><Value Type='Text'>Approve</Value></Eq><IsNull><FieldRef Name='HR_x0020_Status'/></IsNull></And></Where></Query></View>");//V2
    ...
    getItems('Travel Benefit Request',"<View><Query><OrderBy><FieldRef Name='ID' Ascending='FALSE'/></OrderBy><Where><And><IsNull><FieldRef Name='Status_x0020__x0028_HR_x0029_'/></IsNull><Eq><FieldRef Name='Status_x0020__x0028_Immediate_x0'/><Value Type='Text'>Approved</Value></Eq></And></Where></Query></View>");//V2
    ...
    getItems('Educational Benefit Form',"<View><Query><Where><And><Eq><FieldRef Name='Department_x0020_Head_x0020_Appr'/><Value Type='Text'>Approved</Value></Eq><IsNull><FieldRef Name='HR_x0020_Approval'/></IsNull></And></Where></Query></View>");
 ...
 $('#val_hrir').click(function() {
  ...
  $('#val_sdl_v2').click(function() {
    var div_scroll = $("#div_b89428ab-2766-4f50-a94c-4854d9266dd7").position();
  ...
  $('#val_tbr_v2').click(function() {
    var div_scroll = $("#div_b807ae3d-21ba-46fe-aea9-6545419cf298").position();
  ...
  $('#val_ebf_v2').click(function() {
    var div_scroll = $("#div_542c9cab-8422-4100-a226-3c88658f473f").position();
