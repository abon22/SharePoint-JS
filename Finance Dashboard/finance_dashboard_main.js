...
$(document).ready(function() {
  ...
  $('.BTN_OPEN_ITEM_FORM').hide();
    ...
    getItems('Project Resources Purchasing Request',"<View><Query><OrderBy><FieldRef Name='ID' Ascending='FALSE'/></OrderBy><Where><Eq><FieldRef Name='Approval_Stage'/><Value Type='Text'>Finance Approval</Value></Eq></Where></Query></View>");
