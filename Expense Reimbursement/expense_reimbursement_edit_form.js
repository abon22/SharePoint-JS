...
function onRequestSuccess() {
  ...
  function onRequestFail(sender, args) {
    ...
    $("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_savebutton2_ctl00_diidIOSaveItem']").attr('disabled', 'disabled');
...
function get_reimbursement_forms(){
 itemId = GetUrlKeyValue("ID", false, location.href);
         ...
         var list = context.get_web().get_lists().getByTitle('Reimbursement Form');
     ...
     function onSucceededCallback2(sender, args) {
      ...
      var id = listItem.get_item('ID') 
        ...
        if(itemId==id){
      	...
      	fin_status = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val();
		immediate_status = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").val();
    	var immediate_head_appr = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").val();
		var fin_approval = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val();
		var vp_approval = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff151_ctl00_DropDownChoice']").val();
		var ceo_approval = $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff81_ctl00_DropDownChoice']").val();



		if(document.getElementById('ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00').checked) {
		...
		if(immediate_head_appr=="(None)"){
           if(get_preferredname == immediate_head || targetUser=="litoa"  || get_preferredname=="Artem Soukhomlinov | OffshoringTBOS.com"|| targetUser=="aysoukhomlinov"){
            ...
            $("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_savebutton2_ctl00_diidIOSaveItem']").removeAttr('disabled');
            $("#immediate_head_id").hide();
           	$("#item_expenses_tr").hide();
            $("#item_expenses_tr_load").show();
            $("div[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff61_ctl00_ctl00_TextField_inplacerte']").attr('contenteditable', 'true').css('background-color','')
            ...
            $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").attr('disabled', 'disabled');
	        $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").attr('disabled', 'disabled');
	        $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff81_ctl00_DropDownChoice']").attr('disabled', 'disabled');
	        $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff151_ctl00_DropDownChoice']").attr('disabled', 'disabled');
	        $("#immediate_head_id").show();
	        $("#finance_id").show();
     	...
     	else if(immediate_head_appr=="Approved" && fin_approval=="(None)")
	     {
	      $(".ms-propertysheet").css("visibility","hidden")
	          ...
	          if(targetUser=="jestinel" || targetUser=="cherryy"  || targetUser=="litoa"){
	     ...
	     else if(vp_approval=="(None)" && fin_approval=="Unbudgeted")
	     {
     	...
     	//===================================================================================================================================================
	      ...
	      else if(fin_approval=="Budgeted" && ceo_approval=="(None)")
	     {
	 	...
	 	//document.getElementById("ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_c0tl0_DropDownChoice").options[document.getElementById('ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_c0tl0_DropDownChoice').selectedIndex].text;
...
if ($("#ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00").is(":checked")) {
    //console.log("checked");
 ...
 $('#ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00').change(function() {
     if(this.checked) {
...
$("div[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff61_ctl00_ctl00_TextField_inplacerte']").attr('contenteditable', 'false').css('background-color','#F9F9F9');
...
$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff21_ctl00_ctl00_DateTimeField_DateTimeFieldDate']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff31_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff41_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff131_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
$("textarea[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff51_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');

$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff71_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css({'color':'#141414','-webkit-appearance':'none','-moz-appearance':'none','border':'none'});

$("div[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff111_ctl00_ctl00_UserField_upLevelDiv']").attr('contenteditable', 'false').css('background-color','#F6F6F6');
$( "a[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff111_ctl00_ctl00_UserField_checkNames']" ).empty();
$( "a[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff111_ctl00_ctl00_UserField_browse']" ).empty();

$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff161_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
...
$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00']").attr('disabled', 'disabled')
...
var from_cal = document.getElementById("ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff21_ctl00_ctl00_DateTimeField_DateTimeFieldDateDatePickerImage");
from_cal.src = "";
from_cal.alt = ""; 
...
checkuserprofile();
  ...
  //var new_item_html = "<span style='height:10px;width:10px;position:relative;display:inline-block;overflow:hidden;' class='s4-clust'><img src='/_layouts/15/images/fgimg.png?rev=23' alt='' style='left:-0px !important;top:-32px !important;position:absolute;'/> </span> <span> </span><a class='ms-addnew' id='idHomePageNewItem' href='https://intranet.houseofit.com.au/_layouts/15/listform.aspx?PageType=8&amp;ListId=%7B0A53533C%2DCC86%2D48AF%2D99DA%2D9725C32F4664%7D&amp;RootFolder=&amp;' data-viewctr='222' onclick='NewItem2(event, &quot;https://intranet.houseofit.com.au/_layouts/15/listform.aspx?PageType=8&amp;ListId=%7B0A53533C%2DCC86%2D48AF%2D99DA%2D9725C32F4664%7D&amp;RootFolder=&amp;&quot;); return false;' target='_self'> Add new item</a>";
    ...
    table.innerHTML="<br>"+markuptable+""+markupData+""+markuptableend+""+new_item_html+"<br><br>";
     ...
     var frmt_div = document.getElementById('ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff61_ctl00_ctl00_TextField_inplacerte');
  ...
  frmt_div.innerHTML = "<br>"+markuptable2+""+markupData2+""+markuptableend+"<br><br>";
    ...
    document.getElementById('ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff71_ctl00_ctl00_TextField').value = total.format(2);
...
//ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice -- immediate
//ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice -- finance
//ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff81_ctl00_DropDownChoice -- ceo
...
//console.log("fin_status:" +fin_status+" immediate_status:" +immediate_status);
	if($("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val() =="(None)" || 
			$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val() =="Budgeted"|| 
			$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val() =="Unbudgeted"){


			$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00']").removeAttr('disabled');

		$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").removeAttr('disabled');
		$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").removeAttr('disabled');
		$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff151_ctl00_DropDownChoice']").removeAttr('disabled');
		$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff81_ctl00_DropDownChoice']").removeAttr('disabled');

		//console.log("a");


	}else if(fin_status=="For Revision" && immediate_status=="Approved"){
// ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice
// ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice
	...
	}else if($("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").val() =="Approved" && $("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff91_ctl00_DropDownChoice']").val() =="For Revision"){
		$("input[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff141_ctl00_ctl00']").attr('disabled','disabled');
		$("select[id='ctl00_ctl43_g_befa274f_ed7d_4a35_84a1_67e39b417fc8_ff121_ctl00_DropDownChoice']").removeAttr('disabled');
	}
