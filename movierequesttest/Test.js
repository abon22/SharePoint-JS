...
// IF APPROVED by THE IMMEDIATE HEAD -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  if(targetUser == "hoitcebu"+'\\'+"fernandos") {
    SPUtility.ShowSPField('Immediate Head Approval');
...
//     peoplePickerDisplayName: "Immediate Head"
//
//   });
//
//
//   var peopleField = SPUtility.GetSPField('Immediate Head');
//   var value = peopleField.GetValue();
// //  alert(salesRep.getlookup_value());
