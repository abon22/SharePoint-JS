...
var userDepartment = $().SPServices.SPGetCurrentUser({
   fieldName: "Department"
       ...
       $('input[id="Department"]').val(userDepartment); 
...
// ==========================Validation for Attachment=======================================//
        ...
        alert("Upload only a maximum of 5 files");
        return false;       
        }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (fileArray.length > 0) {
                            ...
                            },function(){window.location='https://intranet.houseofit.com.au/Lists/BUGSList/User_AllItems.aspx'});
                        }
                    },
                    error: function (err) {
