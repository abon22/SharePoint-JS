...
function onRequestFail(sender, args) {
    ...
    $("input[id='ctl00_ctl43_g_beb3bd0d_ea90_4c98_9849_de0751c29fe4_ctl00_toolBarTbl_RightRptControls_ctl00_ctl00_diidIOSaveItem']").attr('hidden', 'hidden');
...
function onRequestSuccess() {
 ...
 itemId = GetUrlKeyValue("ID", false, location.href);
         ...
         var list = context.get_web().get_lists().getByTitle('Salary/Device Loan Benefits');
...
//================================================================================================================================================================================
      ...
      console.log("immediate_head: "+immediate_head);
          ...
          }else if(immediate_status=="Approve" && finance_status=="" ){


            if(targetUser=="cherryy" || targetUser=="jestinel" || targetUser=="saraht" || targetUser=="litoa" ){
          ...
          }else if(finance_status=="Approve" && hr_status=="" ){
          ...
          else if(hr_status=="Approve" && vp_status==""  && executive_status==""){
          ...
          else if(vp_status=="Approve" && executive_status=="" ){
          ...
          }else if(executive_status=="Approve" && finance_status=="Approve" ){
