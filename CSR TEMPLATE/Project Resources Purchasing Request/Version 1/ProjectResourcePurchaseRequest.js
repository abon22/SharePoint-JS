...
function Add_PurchaseRequest() {
  ...
  oListItem_AddPurchaseRequest.set_item(
    "Initial_x0020_Approver",
    document.getElementById("INPUT_INITIAL_APPROVER").value
  );
  oListItem_AddPurchaseRequest.set_item(
    "Project_x0020_Name",
  ...
  if (document.getElementById("INPUT_INITIAL_APPROVER").value == "AVP-IT") {
    oListItem_AddPurchaseRequest.set_item("First_Approver", "Scott Osgood");
  } else if (
    document.getElementById("INPUT_INITIAL_APPROVER").value == "AVP-SALES"
  ) {
    oListItem_AddPurchaseRequest.set_item("First_Approver", "Alin Florea");
  } else if (document.getElementById("INPUT_INITIAL_APPROVER").value == "VP") {
    oListItem_AddPurchaseRequest.set_item("First_Approver", "Mithi Sandalo");
  }
