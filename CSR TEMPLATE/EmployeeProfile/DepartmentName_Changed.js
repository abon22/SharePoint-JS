...
(function ($, undefined)
{
    $("document").ready(function ()
    {
        ...
        old_department = document.getElementById("Title_fa564e0f-0c70-4ab9-b863-0177e6ddd247_$TextField").value;
...

{
    ...
    var new_department = document.getElementById("Title_fa564e0f-0c70-4ab9-b863-0177e6ddd247_$TextField").value;

//console.log("final_department:"+final_department);


setCookie("new_department", new_department, 30);
setCookie("old_department", old_department, 30);
