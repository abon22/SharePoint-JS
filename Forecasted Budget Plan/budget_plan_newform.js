...
(function ($, undefined)
{
    ...
    {
         $("#ctl00_ctl43_g_5e8d5497_face_4320_b977_6d2942ae9afb_ff41_ctl00_ctl00_TextField").mask("9999",{placeholder:"YYYY"});

        var inputcontrols = document.getElementsByTagName("input");
        for(i = 0; i<inputcontrols.length; i++)
        {
            if(inputcontrols[i].type == "button" && inputcontrols[i].value == "Save")
                inputcontrols[i].value = "Add Budget";
        }
        var ribbonSave = $("span.ms-cui-ctl-largelabel:contains('Save')");
        ribbonSave.text("Add Budget");
    });
...
function onRequestSuccess() {
    ...
    //alert(requestorName);
    document.getElementById('ctl00_ctl43_g_5e8d5497_face_4320_b977_6d2942ae9afb_ff21_ctl00_ctl00_TextField').value = requestorName;
    document.getElementById('ctl00_ctl43_g_5e8d5497_face_4320_b977_6d2942ae9afb_ff31_ctl00_ctl00_TextField').value = department;
...
immediate_head_var = manager;
  ...
  function onRequestFail(sender, args) {
      ...
      $("input[id='ctl00_ctl43_g_5e8d5497_face_4320_b977_6d2942ae9afb_savebutton2_ctl00_diidIOSaveItem']").attr('hidden', 'hidden');
