...
$("textarea[id='ctl00_ctl42_g_5e4abe5a_f3c0_4b4f_bceb_278dcd9c92b5_ff61_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
$("textarea[id='ctl00_ctl42_g_5e4abe5a_f3c0_4b4f_bceb_278dcd9c92b5_ff71_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
...
$("textarea[id='ctl00_ctl42_g_5e4abe5a_f3c0_4b4f_bceb_278dcd9c92b5_ff91_ctl00_ctl00_TextField']").attr('readonly', 'readonly').css('background-color','#F6F6F6');
	 ...
	 //hide submit button
       $("input[id='ctl00_ctl42_g_5e4abe5a_f3c0_4b4f_bceb_278dcd9c92b5_savebutton2_ctl00_diidIOSaveItem']").attr('hidden', 'hidden');
